\chapter{Esempio}
    ...
    \begin{figure}[hbt!]
        \includegraphics[scale=0.9]{schema.jpg}
        \centering
...
\begin{section}{Generatori}
    \begin{subsection}{Generatore Triboelettrico}
        ...
        \begin{figure}[hbt!]
            \includegraphics[scale=0.5]{funzioneTEG.jpg}
            \centering
    ...
    \begin{subsection}{Generatore a Radiofrequenza}
        ...
        \begin{figure}[hbt!]
            \includegraphics[scale=0.5]{funzioneRF.jpg}
            \centering
...
\begin{section}{Integrazione}
    ...
    \begin{figure}[hbt!]
        \includegraphics[scale=0.75]{schemaPMC.jpg}
        \centering
